...
const Pulse = lazy(() => import('../components/Pulse'));
      ...
      a={
        <>
          <AppAnnouncement
            ...
            description="We've launched a brand new experience to accelerate your workflow. Check out the guides to help you get the most of Cosmos."
            details={[
              'New React based UI rendering',
              'Support for followers and recents',
